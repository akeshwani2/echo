...
export default function Features() {
  return (
    ...
    <ul className="grid grid-cols-1 grid-rows-none gap-4 md:grid-cols-12 md:grid-rows-3 lg:gap-4 xl:max-h-[34rem] xl:grid-rows-2 px-60">
      <GridItem
        ...
        <div className="relative flex h-full flex-col justify-between gap-6 overflow-hidden rounded-xl border-0.75 p-6  dark:shadow-[0px_0px_27px_0px_#2D2D2D] md:p-6">
          <div className="relative flex flex-1 flex-col justify-between gap-3">
            ...
            <div className="space-y-1">
              ...
              <h2
                className="[&_b]:md:font-semibold [&_strong]:md:font-semibold font-sans text-xs/[1.125rem] 
              md:text-sm text-black dark:text-neutral-400"
              >
                {description}
              </h2>
            </div>
